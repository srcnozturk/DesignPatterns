using DesignPattern.TemplateMethod.TempaleteMethod;
...
namespace DesignPattern.TemplateMethod.Controllers
{
    public class DefaultController : Controller
    {
        public IActionResult BasicPlanIndex()
        {
            ...
            ViewBag.v5 = netflixPlans.Resulotion("480px");
            return View();
        }
		public IActionResult StandartPlanIndex()
		{
			...
			ViewBag.v5 = netflixPlans.Resulotion("720px");
			return View();
		}
        public IActionResult UltraPlanIndex()
        {
            ...
            ViewBag.v5 = netflixPlans.Resulotion("1080px");
            return View();
        }
    }
}
